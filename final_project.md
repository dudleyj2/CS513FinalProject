...
According to the TomTom Traffic Index Report, traffic across cities worldwide had been steadily increasing for years until the Covid-19 pandemic temporarily reduced the number of commuters and city residents in many metropolitan areas.  After initial shake-out phases and pilot programs, many American cities in particular have embraced scooter programs not only as a way of reducing traffic, but as an extension of public transportation where infrastructure where it is lacking.  There are many things to be learned about these scooters, and thankfully they produce a lot of data [fix sentence]

## Identified Dataset
The dataset that has been selected for this project is E-Scooter Trips – 2020 from Data World and the city of Chicago.  This raw dataset consists of ~630,000 entries of scooter commuter data in Chicago, Illinois, from August to December of 2020. 
